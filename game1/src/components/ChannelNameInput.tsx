...
export function ChannelNameInput({ onSubmit }: Props) {
  ...
  return (
    <div className="min-h-dvh bg-gray-900 flex flex-col items-center justify-center px-6">
      ...
      <h1 className="text-3xl font-bold mb-2">YouTuber Tycoon</h1>
      <p className="text-gray-400 mb-8">Grow from 0 subscribers to a media empire!</p>

      <div className="w-full max-w-sm space-y-4">
        <div>
          <label className="text-sm text-gray-400 block mb-2">What&apos;s your channel name?</label>
          <input
            type="text"
            value={name}
